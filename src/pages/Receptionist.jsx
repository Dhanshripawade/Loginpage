      ...
      <div className="flex flex-col w-full p-4">
        ...
        {showForm && (
          <form
            ...
            className="absolute right-0 z-10 grid grid-cols-1 gap-2 p-4 mt-24 bg-gray-300 rounded-md shadow md:grid-cols-2 text-end"
          >
            {["rID","name", "username", "email", "phoneNumber", "address","department", "password"].map((field) => (
              <input
                key={field}
        ...
        <div className="relative mt-4 overflow-x-auto">
          <table className="w-full text-sm text-left border border-gray-300">
            <thead className="text-gray-700 bg-gray-100">
              <tr>
                {["rID","Name", "Email", "Phone", "Username","address", "Gender", "Department", "DOB", "Action"].map(
                  (header) => (
  ...
  {showViewModal && selectedReception && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ">
            <div className="p-6 bg-white rounded shadow-lg w-50">
              ...
              <li><strong>_id:</strong> {selectedReception._id}</li>
              <li><strong>rID:</strong> {selectedReception.rID}</li>
                <li><strong>Name:</strong> {selectedReception.name}</li>
                <li><strong>Email:</strong> {selectedReception.email}</li>
                <li><strong>Phone:</strong> {selectedReception.phoneNumber}</li>
                <li><strong>address:</strong> {selectedReception.address}</li>
                <li><strong>Username:</strong> {selectedReception.username}</li>
                <li><strong>Gender:</strong> {selectedReception.gender}</li>
                <li><strong>DOB:</strong> {selectedReception.dateOfBirth}</li>
                <li><strong>Department:</strong> {selectedReception.department}</li>
                <li><strong>password:</strong> {selectedReception.password}</li>
                <li><strong>updatedAt:</strong> {selectedReception.updatedAt}</li>
                <li><strong>createdAt:</strong> {selectedReception.createdAt}</li>
