...
// toast.success("Registration Sucessfuly....Login")
  ...
  // const validateForm = () => {
  //   const newErrors = {};
  //   const { cIN,name,gender,dateOfBirth,specialization,specialty,qualification,medicalLicenseNumber,email,phoneNumber, yearOfExperience,username, password } = formData;

  //   if (!cIN) newErrors.cIN = 'cIN is required';
  //   if (!name) newErrors.name = 'Name is required';
  //   if (!gender) newErrors.gender = 'gender is required';
  //   if (!dateOfBirth) newErrors.dateOfBirth = 'dateOfBirth is required';
  ...
  //   if (!medicalLicenseNumber) newErrors.medicalLicenseNumber = 'medicalLicenseNumber is required';
  //   if (!email) newErrors.email = 'email is required';
  //   if (!phoneNumber) newErrors.phoneNumber = 'Phone number is required';
  //   if (!yearOfExperience) newErrors.yearOfExperience = 'yearOfExperience is required';
